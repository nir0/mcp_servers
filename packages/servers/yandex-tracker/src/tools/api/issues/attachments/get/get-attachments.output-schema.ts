/**
 * Output Schema для GetAttachmentsTool
 *
 ...
 * Output Schema для GetAttachmentsTool
 */
export const GetAttachmentsOutputSchema = z.object({
    ...
    successful: z
      .array(
        z.object({
          ...
          attachmentsCount: z.number().describe('Количество файлов'),
          attachments: z.array(AttachmentEntitySchema).describe('Список файлов'),
        })
      )
      .describe('Успешно полученные файлы'),
    failed: z
      .array(
        z.object({
          issueId: z.string().describe('Ключ задачи'),
