/**
 * Output Schema для UpdateIssueTool
 *
...
export const UpdateIssueOutputSchema = z.object({
  ...
  data: z.object({
    issueKey: z.string().describe('Ключ обновлённой задачи'),
    updatedFields: z.array(z.string()).describe('Список обновлённых полей'),
    issue: IssueEntitySchema.describe('Данные обновлённой задачи'),
