/**
 * Output Schema для UpdateQueueTool
 *
 ...
 * Output Schema для UpdateQueueTool
 */
export const UpdateQueueOutputSchema = z.object({
  success: z.boolean().describe('Статус выполнения'),
  data: z.object({
    queueKey: z.string().describe('Ключ обновлённой очереди'),
    queue: QueueEntitySchema.describe('Обновлённая очередь'),
