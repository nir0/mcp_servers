/**
 * Output Schema для CreateQueueTool
 *
 ...
 * Output Schema для CreateQueueTool
 */
export const CreateQueueOutputSchema = z.object({
  success: z.boolean().describe('Статус выполнения'),
  data: z.object({
    queueKey: z.string().describe('Ключ созданной очереди'),
    queue: QueueEntitySchema.describe('Созданная очередь'),
